...
namespace coworktest {
    ...
    public class WareDbTest {
        ...
        public void Setup() {
            ...
            userId = userRepository.Create(new User(-1, "Alexandre", "testwarebooking", "warebooking@test.com", false, UserType.User));
            wareBookingId =
        ...
        [Test]
        public void Create() {
            var ware = new Ware(-1, "Dell T2600", "workstation de bureau", "1322kjkj573-13242142-n1287z", placeId, false);
